            ...
            <div class="row">
                <div class="col s12 m8">
                    <div class="single-title">
                        <h4 class="single-title">{{ $property->title }} (${{ $property->price }})</h4>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col s12 m8">
                    ...
                    <div class="card-no-box-shadow card">
                        <div class="p-15 grey lighten-4">
                            <h5 class="m-0">
                                {{ $property->approved_comments_count }} Comments
                                @auth
                        ...
                        <div class="single-narebay p-15">
                            ...
                            @foreach($property->approved_comments as $comment)
...
@section('scripts')
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDt0bDBf0gvxqJY2_SpoOI8W8YHa72f8Qw&callback=initMap">
    </script>
@endsection