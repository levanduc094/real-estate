        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m8">
                            ...
                            @foreach($post->related_news as $news)
                                    <div class="comment">
                                        <div class="author-image">
                                            <span style="background-image:url({{ Storage::url('users/'.$news->image) }});"></span>
                                        </div>
                                        <div class="content">
                                            <div class="author-name">
                                                <a href="{{ route('blog.show',$news->slug) }}"><strong>{{ $news->title }}</strong></a>
                    ...
                    <div class="card" id="comments">
                        <div class="p-15 grey lighten-4">
                            <h5 class="m-0">{{ $post->approved_comments_count }} Comments</h5>
                        </div>
                        <div class="single-narebay p-15">
