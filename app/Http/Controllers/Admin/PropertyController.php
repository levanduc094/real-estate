...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($image)){
            ...
            $propertyimage = Image::make($image)->save($imagename);
        ...
        if(isset($floor_plan)){
            ...
            $propertyfloorplan = Image::make($floor_plan)->save($imagefloorplan);
        ...
        if($gallary)
        {
            foreach($gallary as $images)
            {
                ...
                $propertyimage = Image::make($images)->save($galimage['name']);
